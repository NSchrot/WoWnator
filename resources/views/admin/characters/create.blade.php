                    ...
                    <form action="{{ route('admin.characters.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="gender" name="gender" type="text" class="mt-1 block w-full" :value="old('gender')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="race" name="race" type="text" class="mt-1 block w-full" :value="old('race')" required />
                                <x-input-error class="mt-2" :messages="$errors->get('race')" />
                            </div>
                            <div>
                                <x-input-label for="faction" :value="__('Facção')" />
                                <x-text-input id="faction" name="faction" type="text" class="mt-1 block w-full" :value="old('faction')" required />
                                <x-input-error class="mt-2" :messages="$errors->get('faction')" />
                            </div>
                            <div>
                                <x-input-label for="realm" :value="__('Reino')" />
                                <x-text-input id="realm" name="realm" type="text" class="mt-1 block w-full" :value="old('realm')" required />
                                <x-input-error class="mt-2" :messages="$errors->get('realm')" />
                            </div>
                            <div class="md:col-span-2">
                                <x-input-label for="xpac" :value="__('Expansão de Origem')" />
                                <x-text-input id="xpac" name="xpac" type="text" class="mt-1 block w-full" :value="old('xpac')" required />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="splash_url" name="splash_url" type="url" class="mt-1 block w-full" :value="old('splash_url')" />
